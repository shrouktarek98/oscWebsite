                ...
                <div class="container-fluid pad" >
                  ...
                  <div class="collapse navbar-collapse baseNavbarText row" id="navbarsExample07">
                    ...
                    <ul class="navbar-nav mr-auto col-5">
                        <li class="nav-item">
                            <a class="nav-link baseNavbarText" href="{{ URL::to('/#ourStory') }}" >Our Story</a>
                        </li>
                        
                        <li class="nav-item">
                            <a class="nav-link"  href="{{ URL::to('/#heighboard') }}">Highboard</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link"href="{{ URL::to('/#sponser') }}">Sponsers</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ URL::to('/#contactUs') }}">Contact Us</a>
                        </li>
